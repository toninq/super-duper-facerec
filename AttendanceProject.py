...
images = [] # list of data
classNames = []
myList = os.listdir(path) # path = imagesAttendance,
                          # print(myList) : ['jisoo.jpg', 'lisa.jpg', 'reso.jpg']


for cls in myList:
    curImg = cv2.imread(f'{path}/{cls}') # path / img_filename read => currImg
...
print(len(encodeListKnown), 'Encodind complete')

#init webcam
cap = cv2.VideoCapture(0) # our id : 0

while True: # get frame by frame
